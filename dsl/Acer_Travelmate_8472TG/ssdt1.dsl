 ...
 *
 * Disassembly of ssdt1.dat, Sat May 28 16:43:05 2016
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x00002848 (10312)
 *     Revision         0x01
 *     Checksum         0xB1
 *     OEM ID           "NvdRef"
...
DefinitionBlock ("ssdt1.aml", "SSDT", 1, "NvdRef", "NvdTabl", 0x00001000)
{
    ...
    External (_SB_.PCI0.LPCB.EC0_.BBST, FieldUnitObj)
    ...
    External (_SB_.WMID.BAEF, IntObj)
    ...
    Scope (\_SB.PCI0.P0P2)
    {
        ...
        OperationRegion (XPCI, SystemMemory, 0xE0100000, 0x1000)
        ...
        OperationRegion (AHDR, SystemMemory, 0xE0101000, 0x1000)
        Field (AHDR, DWordAcc, Lock, Preserve)
        {
            Offset (0x40), 
            R140,   32, 
            Offset (0x68), 
    ...
    Scope (\_SB.PCI0.P0P2.PEGP)
    {
        ...
        Name (DVSV, Buffer (0x4C) {})
        CreateDWordField (DVSV, Zero, B000)
        CreateDWordField (DVSV, 0x04, B004)
        CreateDWordField (DVSV, 0x08, B008)
        CreateDWordField (DVSV, 0x0C, B00C)
        CreateDWordField (DVSV, 0x10, B010)
        CreateDWordField (DVSV, 0x14, B014)
        CreateDWordField (DVSV, 0x18, B018)
        CreateDWordField (DVSV, 0x1C, B01C)
        CreateDWordField (DVSV, 0x20, B020)
        CreateDWordField (DVSV, 0x24, B024)
        CreateDWordField (DVSV, 0x28, B028)
        CreateDWordField (DVSV, 0x2C, B02C)
        CreateDWordField (DVSV, 0x30, B030)
        CreateDWordField (DVSV, 0x34, B034)
        CreateDWordField (DVSV, 0x38, B038)
        CreateDWordField (DVSV, 0x3C, B03C)
        CreateDWordField (DVSV, 0x40, B040)
        CreateDWordField (DVSV, 0x44, B04C)
        CreateDWordField (DVSV, 0x48, B140)
        Method (VSAV, 0, NotSerialized)
        {
            B040 = R040 /* \_SB_.PCI0.P0P2.R040 */
            B140 = R140 /* \_SB_.PCI0.P0P2.R140 */
        }

        Method (VRES, 0, NotSerialized)
        {
            R040 = B040 /* \_SB_.PCI0.P0P2.PEGP.B040 */
            R140 = B140 /* \_SB_.PCI0.P0P2.PEGP.B140 */
        }

        Method (DDMI, 0, NotSerialized)
        {
            VDMI = Zero
        }
    }
    ...
    Scope (\_SB.PCI0.GFX0)
    {
        ...
        Method (MXMX, 1, Serialized)
        {
            ...
            If ((Arg0 == 0x02))
            {
                Return (\_SB.PCI0.P0P2.PEGP.PO67)
            }
        ...
        Method (_DSM, 4, Serialized)  // _DSM: Device-Specific Method
        {
            ...
            If ((Arg0 == ToUUID ("9d95a0a0-0060-4d48-b34d-7e5fea129fd4")))
            {
                ...
                If ((Arg2 == 0x03))
                {
                    ...
                    ElseIf ((\_SB.PCI0.P0P2.PEGP._STA () == 0x0F))
                    {
                        Return (One)
                    }
                    Else
